...
var ConsoleHandler = /**
    ...
    _inherits(ConsoleHandler, _AbstractHandler);
    ...
    */
    function ConsoleHandler(minLevel) {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(ConsoleHandler).call(this, minLevel, _nightingaleAnsiFormatter2.default, _nightingaleConsoleOutput2.default));
    }
